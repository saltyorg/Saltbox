...
python3 -m pip install --no-cache-dir --disable-pip-version-check ansible">=5.0.0,<6.0.0" 1>>/srv/git/saltbox/ansible-update.log 2>>/srv/git/saltbox/ansible-update.log
